...
https://ci.appveyor.com/project/k-l-a/main/branch/master[image:https://ci.appveyor.com/api/projects/status/rtvl6n00jsm1ad4a/branch/master?svg=true[Build status]]
