...
Adds a contact and their information to the address book. +
...
or `e INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY] [v/AVATAR] [t/TAG]...`
...
Change Theme, "theme | t", theme Light, t Dark
