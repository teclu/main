...
== Command Cheatsheet
[format="csv"]
[options="header",cols="^4m,1m,1m"]
|===========================
Command | Alias,Format,Example
"add | a",add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS b/BIRTHDAY [t/TAG]... ,"add n/James Ho "


"clear | c", clear, clear
 "delete | d", delete INDEX, delete 3
"edit | e", INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY] [t/TAG]..., edit 2 n/James Lee
 "addtag | at", addtag INDEX TAG, addtag 2 friends
 "deletag | dt", deletetag INDEX TAG, deletetag 2 friends
 "find | f", find [PREFIX] KEYWORD [MORE_KEYWORDS], find n/ James Jake
 "list | l", list, list
 help, help, help
 "select | s", select INDEX, select 2
 sort   , sort [PREFIX] [ORDER], sort n/ asc
