...
Add,"add | a",add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS b/BIRTHDAY [t/TAG]... ,"add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 b/16/08/1995 t/friend t/colleague"


Clear,"clear | c", clear, clear
Delete, "delete | d", delete INDEX, delete 3
Edit, "edit | e", edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [b/BIRTHDAY] [t/TAG]..., edit 2 n/James Lee
Add Tag, "addtag | at", addtag INDEX TAG, addtag 2 friends
Delete Tag, "deletag | dt", deletetag INDEX TAG, deletetag 2 friends
