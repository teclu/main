= K.N.S. AddressBook v1.5.0rc - Developer Guide
:toc:
:toc-title:
:toc-placement!:
:sectnums:
...
_Figure 4.2.2.1: Visual breakdown of PersonPanel_
...
The display and storage of a display picture can be seen in the following code snippets:
...
AvatarWindow is a UI component and is triggered when the current avatar of a contact is clicked on. A window
...
image::ImportExportAssocDiagram.png[width="800"]
