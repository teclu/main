...
public class FindCommandSystemTest extends AddressBookSystemTest {
    ...
    public void find() {
        ...
        /* Case: find phone number of person in address book without prefix (assumed as name) -> 0 persons found */
        command = FindCommand.COMMAND_WORD + " " + DANIEL.getPhone().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find address of person in address book without prefix (assumed as name) -> 0 persons found */
        command = FindCommand.COMMAND_WORD + " " + DANIEL.getAddress().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find email of person in address book without prefix (assumed as name) -> 0 persons found */
