...
public class CommandTestUtil {
    ...
    public static final String VALID_AVATAR_AMY = "https://i.imgur.com/pXNW6nZ.jpg";
    public static final String VALID_AVATAR_BOB = "https://i.imgur.com/ET0WJCb.png";
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY + "01 January 1991"; // 'a' not allowed
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withBirthday(VALID_BIRTHDAY_AMY).withAvatar(VALID_AVATAR_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withBirthday(VALID_BIRTHDAY_BOB).withAvatar(VALID_AVATAR_BOB)
